...
window.onload = function init() {
    ...
    var show_fovy = document.getElementById("show-fovy");
    document.getElementById("fovy").onchange = function(event) {
        fovy = event.target.value;
        show_fovy.textContent = fovy;
        render();
    };

    var show_near = document.getElementById("show-near");
    document.getElementById("near").onchange = function(event) {
        near = event.target.value;
        show_near.textContent = near;
        render();
    };

    var show_far = document.getElementById("show-far");
    document.getElementById("far").onchange = function(event) {
        far = event.target.value;
        show_far.textContent = far;
        render();
    };
