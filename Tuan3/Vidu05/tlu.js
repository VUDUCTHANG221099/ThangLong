...
window.onload = function init() {
  ...
  document.getElementById("slider_x").onchange = function (event) {
    slider_x = parseInt(event.target.value);

    var vertices_new = transform_translate(vertices_t, slider_x, slider_y);
  ...
  document.getElementById("slider_y").onchange = function (event) {
    slider_y = parseInt(event.target.value);
...
function transform_translate(vertices_in, distance_x, distance_y) {
  var mat3_t = mat3(1.0, 0.0, distance_x, 0.0, 1.0, distance_y, 0.0, 0.0, 1.0);
